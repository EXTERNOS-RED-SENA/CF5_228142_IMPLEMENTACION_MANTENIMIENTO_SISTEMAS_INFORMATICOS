export default {
  ...
  complementario: [
    {
      ...
      referencia:
        'Ecosistema de Recursos Educativos Digitales SENA. (2021f, junio 25). <em>Tecnologías inalámbricas.</em>',
      tipo: 'Video',
    ...
    },
    {
      tema: '2. Site Survey',
      referencia:
        'Ecosistema de Recursos Educativos Digitales SENA. (2023d, octubre 30). <em>Infraestructura Inalambrica.</em>',
      tipo: 'Video',
    ...
    },
    {
      ...
      referencia:
        'Ecosistema de Recursos Educativos Digitales SENA. (2022f, marzo 11). <em>Dispositivos y componentes IoT.</em>',
      tipo: 'Video',
    ...
    },
    {
      ...
      referencia:
        'Ecosistema de Recursos Educativos Digitales SENA. (2023e, enero 29). <em>Seguridad en redes inalámbricas.</em>',
      tipo: 'Video',
    ...
    },
    {
      ...
      referencia:
        'Contando Bits. (2024c, agosto 8). <em>Protocolos de seguridad  (WEP, WPA, WPA2).</em>',
      tipo: 'Video',
      link: '',
    },
  ],
  ...
  referencias: [
    {
      referencia:
        'Alvear-Puertas, V., Rosero-Montalvo, P., & Peluffo-Ordóñez, D. (2017). <em>Internet de las Cosas y Visión Artificial: Funcionamiento y aplicaciones: Revisión de literatura.</em> Tomado de Internet de las Cosas y Visión Artificial, Funcionamiento y Aplicaciones: Revisión de Literatura',
      link: '',
    },
    {
      referencia:
        'Bluetooth Special Interest Group (SIG). (2021). <em>Bluetooth Core Specification Version 5.3.</em> Bluetooth SIG.',
      link:
    ...
    {
      referencia:
        'Wi-Fi Alliance. (2022). Wi-Fi Certified 6™ Release 2: Bringing Enhanced Features and Capabilities. Wi-Fi Alliance. ',
      link:
        'https://www.wi-fi.org/beacon/the-beacon/the-future-of-wi-fi-using-standardized-key-performance-indicators-and-evaluation?form=MG0AV3',
    },
  ],
}
